...
template <class X, class Y> bool equals( X x, Y y )
{
    return ( x == y );
}
...
template <class X, class Y> bool differs( X x, Y y )
{
    return !( x == y );
}
...
template <class X, class Y> bool lessThan( X x, Y y )
{
    return ( x < y );
}
...
template <class X, class Y> bool lessThanEquals( X x, Y y )
{
    return ( x <= y );
}
...
#define ___TS_ASSERT_EQUALS( f, l, x, y, m )                                                       \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_EQUALS( f, l, x, y, m );                                                 \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_SAME_DATA( f, l, x, y, s, m )                                                 \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_SAME_DATA( f, l, x, y, s, m );                                           \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_DIFFERS( f, l, x, y, m )                                                      \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_DIFFERS( f, l, x, y, m );                                                \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_LESS_THAN( f, l, x, y, m )                                                    \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_LESS_THAN( f, l, x, y, m );                                              \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_LESS_THAN_EQUALS( f, l, x, y, m )                                             \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_LESS_THAN_EQUALS( f, l, x, y, m );                                       \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_PREDICATE( f, l, p, x, m )                                                    \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_PREDICATE( f, l, p, x, m );                                              \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_RELATION( f, l, r, x, y, m )                                                  \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_RELATION( f, l, r, x, y, m );                                            \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define ___TS_ASSERT_DELTA( f, l, x, y, d, m )                                                     \
    {                                                                                              \
        _TS_TRY                                                                                    \
        {                                                                                          \
            ___ETS_ASSERT_DELTA( f, l, x, y, d, m );                                               \
        }                                                                                          \
        __TS_CATCH( f, l )                                                                         \
    }
...
#define CXXTEST_COMPARISONS( CXXTEST_X, CXXTEST_Y, CXXTEST_T )                                     \
    inline bool equals( CXXTEST_X x, CXXTEST_Y y )                                                 \
    {                                                                                              \
        return ( ( (CXXTEST_T)x ) == ( (CXXTEST_T)y ) );                                           \
    }                                                                                              \
    inline bool equals( CXXTEST_Y y, CXXTEST_X x )                                                 \
    {                                                                                              \
        return ( ( (CXXTEST_T)y ) == ( (CXXTEST_T)x ) );                                           \
    }                                                                                              \
    inline bool differs( CXXTEST_X x, CXXTEST_Y y )                                                \
    {                                                                                              \
        return ( ( (CXXTEST_T)x ) != ( (CXXTEST_T)y ) );                                           \
    }                                                                                              \
    inline bool differs( CXXTEST_Y y, CXXTEST_X x )                                                \
    {                                                                                              \
        return ( ( (CXXTEST_T)y ) != ( (CXXTEST_T)x ) );                                           \
    }                                                                                              \
    inline bool lessThan( CXXTEST_X x, CXXTEST_Y y )                                               \
    {                                                                                              \
        return ( ( (CXXTEST_T)x ) < ( (CXXTEST_T)y ) );                                            \
    }                                                                                              \
    inline bool lessThan( CXXTEST_Y y, CXXTEST_X x )                                               \
    {                                                                                              \
        return ( ( (CXXTEST_T)y ) < ( (CXXTEST_T)x ) );                                            \
    }                                                                                              \
