...
const char *RealTestDescription::file() const
{
    return _suite->file();
}
unsigned RealTestDescription::line() const
{
    return _line;
}
const char *RealTestDescription::testName() const
{
    return _testName;
}
...
TestSuite *RealTestDescription::suite() const
{
    return _suite->suite();
}
...
unsigned RealSuiteDescription::line() const
{
    return _line;
}
const char *RealSuiteDescription::suiteName() const
{
    return _suiteName;
}
...
unsigned RealSuiteDescription::numTests() const
{
    return _tests->size();
}
