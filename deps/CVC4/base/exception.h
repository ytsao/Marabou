...
protected:
    ...
    void construct( const char *header, const char *extra, const char *function, const char *tail );
...
template <class T>
inline void CheckArgument( bool cond, const T &arg, const char *tail ) CVC4_PUBLIC;
template <class T>
inline void CheckArgument( bool cond, const T &arg CVC4_UNUSED, const char *tail CVC4_UNUSED )
{
